    ...
    <div class="main">
        ...
        <article class="a2">
          ...
          <article class="content-box">
            <div style="width:650;height:550px;line-height:3em;overflow:scroll;padding:0px; background-color:#E6E6E6">			
			<ol style="list-style-type: decimal;padding-left: 20px;	line-height: 1.54em; font-size:14px">
			<li><b>PERSYARATAN PENDAFTARAN</b></li>
              <p>Kementerian/Lembaga non Kementerian, Pemerintah Daerah Propinsi/Kabupaten/Kota tertentu, membuka kesempatan penerimaan Calon Pegawai Negeri Sipil (CPNS) Tahun 2013 untuk mengisi lowongan formasi dengan kwalifikasi pendidikan tertentu. Seluruh calon peserta test CPNS 2013 diharapkan melakukan pendaftaran secara online dengan ketentuan sebagai berikut;</p>
              <p><b>UMUM</b></p>
			...
			<li><strong>MATERI UJIAN</strong></li>
			<ul style="list-style-type: decimal;padding-left: 20px;	line-height: 1.54em;">
