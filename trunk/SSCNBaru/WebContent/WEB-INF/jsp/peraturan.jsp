...
<div class="main-indents">
    <div class="main">
        <!-- Header -->
        <header>
            <h1 class="logo"><a href="index.html">Diving Club</a></h1>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com. August20, 2012!</div>
      <div class="container_12">
        ...
        <!-- Footer -->
        <footer>
            <div class="copyright"><a href="http://www.templatemonster.com" target="_blank" rel="nofollow">Hak Cipta  Â©  2014 Badan Kepegawaian Negara. Semua Hak Dilindungi.</a></div>
