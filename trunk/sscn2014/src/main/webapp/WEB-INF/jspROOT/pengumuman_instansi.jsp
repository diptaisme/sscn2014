        ...
        <article class="a2">
					...
					<li><a href="pengumuman_instansi_home.html"><img src="/resources/images/pengumuman.jpg" width="243" height="37" border="0" align="left"></a></img></li>												
			   		...
			   		<div class="col-9">
                            ...
                            <p align="justify">
								<form target="_blank" name="formLihatPengumuman" method="POST"
									action="report">
									<input type="hidden" name="typeReport" value="reportPengumuman">
									<input type="hidden" id="instansi" name="instansi" value="${userLogin.refInstansi.kode}">									
									<input type="submit" title="Lihat Pengumuman Instansi"
										value="lihat pengumuman instansi" name="action" />
								</form>
							</p>              
			   </div>
				  </div>
