...
<!--jquery autocomplete-->
<link rel="stylesheet"
	href="/resources/js/jquery-ui-1.8.16/themes/base/jquery-ui.css" type="text/css" />
<script type="text/javascript" src="/resources/js/jquery-ui-1.8.16/ui/jquery-ui.js"></script>
...
<script type="text/javascript" src="/resources/js/daftar1.js"></script>
<script type="text/javascript" src="/resources/js/daftar2.js"></script>
<script type="text/javascript" src="/resources/js/daftar3.js"></script>
...
label.valid {
	width: 24px;
	height: 24px;
	/*background: url(/resources/assets/img/valid.png) center center no-repeat;*/
	...
	<div class="container_12">
		...
		<div class="wrapper">
						<div class="col-10">
							<h3>MENU UTAMA</h3>
							<ul class="list-2">
							<li><a href="informasi_umum.html"><img src="/resources/images/info.jpg" width="243" height="37" border="0" align="left"></a></img></li>
							<li><a href="pengumuman_instansi_home.html"><img src="/resources/images/pengumuman.jpg" width="243" height="37" border="0" align="left"></a></img></li>																							
                            <li><a href="petunjuk.html"><img src="/resources/images/petunjuk.jpg" width="243" height="37" border="0" align="left"></a></img></li>
							</ul>
						</div>
			<div class="col-9">
...
style="width: 390px" size="50" onKeyUp="caps(this)" />
                ...
                <p>
				  ...
				  </select> <img id="imgLoadingPendidikan" src="/resources/images/loading.png" />
                </p>
				<p>
                    <label>Pilihan 1  *
                    </label>
				  ...
				  </select> <img id="imgLoadingLokasi1" src="/resources/images/loading.png" />
                </p>
				<p>
                    <label>
                    </label>
				  ...
				  </select> <img id="imgLoadingJabatan1" src="/resources/images/loading.png" />
                </p>
					...
					<c:when test="${userLogin.refInstansi.jumlahMaxDaftar == '3'}">
						<p>
							...
							<select class="form-dropdown" style="width: 450px"
																...
																<option value="">Pilih lokasi kerja</option>
						  </select> <img id="imgLoadingLokasi2" src="/resources/images/loading.png" />
						</p>
						<p>
		                    <label>
		                    </label>
		                    <select class="form-dropdown" style="width: 450px"
																...
																<option value="">Pilih jabatan</option>
						  </select> <img id="imgLoadingJabatan2" src="/resources/images/loading.png" />
						</p>
						<p>
		                    <label>Pilihan 3  
		                    </label>
		                    <select class="form-dropdown" style="width: 450px"
																...
																<option value="">Pilih lokasi kerja</option>
						  </select> <img id="imgLoadingLokasi3" src="/resources/images/loading.png" />
		                </p>
						<p>
		                    <label>
		                    </label>
		                    <select class="form-dropdown" style="width: 450px"
																...
																<option value="">Pilih jabatan</option>
						  </select> <img id="imgLoadingJabatan3" src="/resources/images/loading.png" />
		                </p>
					</c:when>
				</c:choose>
				<c:choose>
											...
											<tr>
												...
												<div align="center">
															<image id="cekbox" data-type="input-textbox"
																onClick="changeImage()" img src="/resources/images/before.gif"
